...
async def main() -> None:
    ...
    sl_trigger = amount_to_chain_units(70000.0, btc_market.px_decimals)
    sl_limit = amount_to_chain_units(69900.0, btc_market.px_decimals)
