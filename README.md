...
read.user_bulk_orders.get_by_addr(sub_addr)
read.user_subaccounts.get_by_addr(addr)
read.user_fund_history.get_by_addr(sub_addr)
read.user_funding_history.get_by_addr(sub_addr)
read.user_active_twaps.get_by_addr(sub_addr)
read.user_twap_history.get_by_addr(sub_addr)

# Other
read.delegations.get_by_addr(addr)
read.leaderboard.get_all()
read.portfolio_chart.get_by_addr(sub_addr)
read.vaults.get_all()
read.trading_points.get_by_addr(addr)
...
write.place_bulk_orders(orders)
write.cancel_bulk_order(market_name, order_ids)
...
# TWAP
write.place_twap_order(market_name, ...)
write.cancel_twap_order(market_name, twap_order_id)
...
# Vaults
write.deposit_to_vault(vault_addr, amount)
write.withdraw_from_vault(vault_addr, amount)

# Subaccounts
write.create_subaccount()
write.deactivate_subaccount(sub_addr)
```
